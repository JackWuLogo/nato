...
func (wv *valid) Validate(i interface{}) error {
...
func NewValid() *valid {
	...
	// 自定义验证
	_ = v.RegisterValidation("mobile", validMobile)
	_ = v.RegisterTranslation("mobile", trans, regFunc("mobile", "{0}不是有效的手机号", false), tranFunc)

	return &valid{validator: v, translator: trans}
}
